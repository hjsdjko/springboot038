...
public class YishengController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		YishengEntity u = yishengService.selectOne(new EntityWrapper<YishengEntity>().eq("zhanghao", username));
    ...
    public R register(@RequestBody YishengEntity yisheng){
    	...
    	YishengEntity u = yishengService.selectOne(new EntityWrapper<YishengEntity>().eq("zhanghao", yisheng.getZhanghao()));
		if(u!=null) {
    ...
    public R save(@RequestBody YishengEntity yisheng, HttpServletRequest request){
        if(yishengService.selectCount(new EntityWrapper<YishengEntity>().eq("zhanghao", yisheng.getZhanghao()))>0) {
    ...
    public R update(@RequestBody YishengEntity yisheng, HttpServletRequest request){
        //ValidatorUtils.validateEntity(yisheng);
        if(yishengService.selectCount(new EntityWrapper<YishengEntity>().ne("id", yisheng.getId()).eq("zhanghao", yisheng.getZhanghao()))>0) {
            return R.error("账号已存在");
        }
